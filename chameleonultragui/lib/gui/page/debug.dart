...
String mifareClassicRecoveryLogSummary(String operation, int candidateCount) {
  final outcome =
      candidateCount == 0 ? 'no-candidates' : 'candidates-recovered';
  return '$operation recovery: count = $candidateCount, outcome = $outcome';
}
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  for (var i = 0; i < 0xFF && !found; i++) {
                    ...
                    if (keys.isNotEmpty) {
                      appState.log!.d(mifareClassicRecoveryLogSummary(
                          'Nested', keys.length));
                      for (var key in keys) {
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  var keys = await recovery.darkside(darkside);
                  appState.log!.d(mifareClassicRecoveryLogSummary(
                      'Darkside self-test', keys.length));
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  appState.log!.d(mifareClassicRecoveryLogSummary(
                      'Hard nested self-test', keys.length));
                  appState.log!.d(
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  appState.log!.d(mifareClassicRecoveryLogSummary(
                      'Static encrypted nested self-test', keys.length));
